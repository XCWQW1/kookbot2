...
async def restart_connect(websocket):
    global link_status
    global sn
    global wait_json
        ...
        while True:
            ...
            try:
                ...
                if ok_ping_num == 2:
                    ...
                    await restart_connect(websocket)
                        ...
                        try:
                            ...
                            if DEBUG:
                                if str(data) == "{'s': 3}":
                                    ...
                                    Log.diy_log('调试', json.dumps(data) + f'|下一次pong应位于[{str(formatted_time)}]左右')
                                else:
                                    Log.diy_log('调试', json.dumps(data))
                            # DEBUG
